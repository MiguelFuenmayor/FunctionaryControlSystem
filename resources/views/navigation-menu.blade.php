<nav x-data="{ open: false }" class="sticky top-0 z-50 bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('dependency-table') }}" :active="request()->routeIs('dependency-*')">
                        {{ __('Dependencias') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('promo-table') }}" :active="request()->routeIs('promo-*')">
                        {{ __('Promos') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('charge-table') }}" :active="request()->routeIs('charge-*')">
                        {{ __('Cargos') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('rank-table') }}" :active="request()->routeIs('rank-*')">
                        {{ __('Rangos') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('functionary-table') }}" :active="request()->routeIs('functionary-table')">
                {{ __('functionary-table') }}
